"""Korkovts Signal AI V11.12.1 · CONTROL AUDIT."""
...
async def start_v112(update,context):
    ...
    text=(
        ...
        f"\n📡 Broad scan <b>{core.AUTO_SCAN_INTERVAL_MIN}m</b> · Entry monitor <b>30s</b> · Futures L2 <b>100ms</b>\n"
...
async def system_v112(update,context):
    ...
    try:
        ...
        text=(
            "🛡 <b>KORKOVTS V11.12.1 CONTROL AUDIT</b>\n"
            "━━━━━━━━━━━━━━━━━━\n"
