"""Korkovts Signal AI V11.15.0 · STRONG SIGNALS."""
...
async def _arm_and_check(signal,source):
    ...
    if not strong.auto_eligible:
        reason=(strong.blockers[0] if strong.blockers else
...
async def _trigger_arm(context,arm_id,initial_assessment=None,force_chat_id=None):
    ...
    async with _entry_now_lock:
        ...
        priority_label=bool(strong.prime_eligible and _prime_label_candidate(arm_id,row))
