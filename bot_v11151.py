"""Korkovts Signal AI V11.15.1 · INDICATOR EDGE QUALITY-FIRST."""
...
async def _prepare(results,kind):
    ...
    # V11.15.1 quality-first Indicator Edge Pack. This is a negative-only
...
async def _arm_and_check(signal,source):
    ...
    if not strong.auto_eligible or not _indicator_gate(signal):
...
async def _trigger_arm(context,arm_id,initial_assessment=None,force_chat_id=None):
    ...
    async with _entry_now_lock:
        ...
        if not strong.auto_eligible or not _indicator_gate(fresh):
            ...
            reason=((edge.get("blockers") or [None])[0] if not _indicator_gate(fresh) else None) or (
                strong.blockers[0] if strong.blockers else
...
async def signal_v1123(update,context):
    ...
    try:
        ...
        # V11.15.1: manual symbol analysis must pass the same Indicator Edge
...
async def system_v112(update,context):
    ...
    try:
        ...
        text=(
            "🛡 <b>KORKOVTS V11.13.0 GLOBAL INTELLIGENCE</b>\n"
            "━━━━━━━━━━━━━━━━━━\n"
