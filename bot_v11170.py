"""Korkovts Signal AI V11.17.0 · EXECUTION & RISK CORE."""
...
async def _trigger_arm(context,arm_id,initial_assessment=None,force_chat_id=None):
    ...
    async with _entry_now_lock:
        ...
        try:
            ...
            core.log.exception("V11.17 challenger shadow journal failed")
        ...
        try:
            ...
            core.log.exception("V11.16 ENTRY replay capture failed signal=%s",signal_id)
...
async def callback_v112(update,context):
    ...
    if data=="v1114:performance":
        await query.answer()
        return await query.message.reply_text(performance_report_text(),parse_mode=ParseMode.HTML,reply_markup=main_menu())
    if data=="v1114:early":
        await query.answer()
    ...
    if data=="v1116:adaptive":
        await query.answer()
        return await query.message.reply_text(adaptive_edge_report_text(),parse_mode=ParseMode.HTML,reply_markup=main_menu())
    if data=="v1116:replay":
        await query.answer()
        return await query.message.reply_text(replay_recent_text(),parse_mode=ParseMode.HTML,reply_markup=main_menu())
    if data=="v1117:risk":
        await query.answer()
        r=_last_final_risk
        text=("🧿 <b>FINAL RISK GATE · V11.17</b>\n━━━━━━━━━━━━━━━━━━\n"
    ...
    if data=="v1117:challenger":
        await query.answer()
        return await query.message.reply_text(challenger_report_text(),parse_mode=ParseMode.HTML,reply_markup=main_menu())
    if data=="v1117:attribution":
        await query.answer()
        return await query.message.reply_text(attribution_report_text(),parse_mode=ParseMode.HTML,reply_markup=main_menu())
...
async def system_v112(update,context):
    ...
    try:
        ...
        text=(
            "🛡 <b>KORKOVTS V11.17.0 EXECUTION & RISK CORE</b>\n"
            "━━━━━━━━━━━━━━━━━━\n"
