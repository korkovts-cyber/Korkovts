"""Korkovts Signal AI V11.17.1 · EXECUTION & RISK HARDENING."""
...
async def callback_v112(update,context):
    ...
    if data=="v1117:risk":
        await query.answer()
        r=_last_final_risk
        text=("🧿 <b>FINAL RISK GATE · V11.17.1</b>\n━━━━━━━━━━━━━━━━━━\n"
    ...
    if data=="v1117:challenger":
        await query.answer()
        text=await asyncio.to_thread(challenger_report_text)
        return await query.message.reply_text(text,parse_mode=ParseMode.HTML,reply_markup=main_menu())
    if data=="v1117:attribution":
        await query.answer()
        text=await asyncio.to_thread(attribution_report_text)
        return await query.message.reply_text(text,parse_mode=ParseMode.HTML,reply_markup=main_menu())
...
async def system_v112(update,context):
    ...
    try:
        ...
        text=(
            "🛡 <b>KORKOVTS V11.17.1 EXECUTION & RISK HARDENING</b>\n"
            "━━━━━━━━━━━━━━━━━━\n"
