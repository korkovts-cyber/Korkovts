...
if missing:
    raise SystemExit("V11.21.5 PREFLIGHT FAILED missing: "+", ".join(missing))
...
if "python bot_v11191.py" not in railway:
    raise SystemExit("V11.21.5 PREFLIGHT FAILED railway entrypoint")
...
if bad:
    raise SystemExit("V11.21.5 PREFLIGHT FAILED contracts: "+", ".join(bad))
print("V11.21.5 FULL-UNIVERSE PREFLIGHT: OK")
