...
contracts = [
    ...
    ("V11.21.8+ layered entrypoint", any(x in railway for x in ("python bot_v11218.py","python bot_v11219.py","python bot_v11220.py","python bot_v11221.py","python bot_v11222.py","python bot_v11223.py","python bot_v11224.py","python bot_v11226.py"))),
