...
if bad or not any(x in r for x in ("python bot_v11219.py","python bot_v11220.py")) or "test_v11219_contract.py" not in r: raise SystemExit("V11.21.9 PREFLIGHT contracts failed")
