...
if bad:
    raise SystemExit("V11.22.7 PREFLIGHT core contracts failed: " + ", ".join(bad))

if "python preflight_v11227.py" not in r:
    raise SystemExit("V11.22.7 PREFLIGHT railway missing preflight entrypoint")

if "python bot_v11227.py" not in r:
    raise SystemExit("V11.22.7 PREFLIGHT railway missing production entrypoint")
