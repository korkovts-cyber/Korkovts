...
checks={
 ...
 'test_v11130_core.py':['directional_breaking_can_be_market_confirmed','ambiguous_breaking_stays_fail_closed','arm_resets_confirmation_on_geometry_change','legacy_x_official_flag_is_demoted_to_social_trust','fast_radar_covers_15m_without_extra_candidate_budget'],
}
