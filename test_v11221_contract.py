...
class V11221Contracts(unittest.TestCase):
 ...
 def test_railway(self): self.assertIn("python preflight_v11221.py",self.r); self.assertIn("test_v11221_contract.py",self.r); self.assertTrue(any(x in self.r for x in ("python bot_v11221.py","python bot_v11222.py","python bot_v11223.py","python bot_v11224.py","python bot_v11225.py","python bot_v11226.py")))
