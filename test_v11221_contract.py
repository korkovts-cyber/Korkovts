...
class V11221Contracts(unittest.TestCase):
 ...
 def test_railway(self): self.assertIn("python preflight_v11221.py",self.r); self.assertIn("test_v11221_contract.py",self.r); self.assertTrue("python bot_v11221.py" in self.r or "python bot_v11222.py" in self.r)
