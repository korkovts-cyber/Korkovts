"""V11.21.6 · Signal Engine Rebalance + fresh-cohort isolation."""
...
FUTURES_COHORT="11.21.6-signal-engine"
SPOT_COHORT="11.21.6-spot-signal-engine"
...
def install(base):
    ...
    # under V11.21.6 rules, and keep forward statistics in a clean cohort.
    ...
    def strong_annotate(signal):
        ...
        signal.feature_snapshot.setdefault("strong_consensus_v11150",{}).update({
            "schema":"11.21.6-strong-consensus-compat",
    ...
    # generated by the exact same V11.21.6 assessment.
    ...
    def spot_was_sent_recently_current(symbol,hours=72):
        ...
        # delivery must not suppress the first valid V11.21.6 BUY for 72 hours.
        spot_db.init()
